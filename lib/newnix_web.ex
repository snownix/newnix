defmodule NewnixWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: NewnixWeb
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {NewnixWeb.LayoutView, "live.html"}
